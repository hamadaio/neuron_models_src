...
#define nrn_init _nrn_init__nais
#define _nrn_initial _nrn_initial__nais
#define nrn_cur _nrn_cur__nais
#define _nrn_current _nrn_current__nais
#define nrn_jacob _nrn_jacob__nais
#define nrn_state _nrn_state__nais
#define _net_receive _net_receive__nais 
#define kin kin__nais 
#define rates rates__nais 
...
extern Memb_func* memb_func;
 ...
 "setdata_nais", _hoc_setdata,
 "rates_nais", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define maxrate maxrate_nais
 double maxrate = 8000;
#define q10h q10h_nais
 double q10h = 2.3;
#define q10 q10_nais
 double q10 = 2.3;
#define temp temp_nais
 double temp = 23;
#define vShift_inact vShift_inact_nais
 double vShift_inact = 10;
#define vShift vShift_nais
 double vShift = 12;
 ...
 "ah_0_nais", "/ms",
 "ah_2_nais", "/mV",
 "vShift_inact_local_nais", "mV",
 "gna_nais", "millimho/cm2",
 "ina_inax_nais", "milliamp/cm2",
 0,0
};
 static double c30 = 0;
 static double c20 = 0;
 ...
 "vShift_nais", &vShift_nais,
 "vShift_inact_nais", &vShift_inact_nais,
 "maxrate_nais", &maxrate_nais,
 "temp_nais", &temp_nais,
 "q10_nais", &q10_nais,
 "q10h_nais", &q10h_nais,
 0,0
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _nax8st_as_nax_q10_gnais_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("na", -10000.);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nais /Users/maartenkole/Desktop/Human/27_08_14_#3_hu/x86_64/nax8st_as_nax_q10_gnais.mod\n");
