...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 15, 3);
 	...
 	ivoc_help("help ?1 it2 /Users/Hamada/Dropbox/research/Analyses/Project-4__MH/NEURON_sim/human_model/2015_10_14_c1_syn_hu/x86_64/CaT.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 84 in file CaT.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
