...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _nax8st_as_nax_q10_gnax_reg() {
	int _vectorized = 1;
  _initlists();
 	ion_reg("na", -10000.);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 52, 4);
 	...
 	ivoc_help("help ?1 nax /Users/Hamada/Dropbox/research/Analyses/Project-4__MH/NEURON_sim/human_model/2015_10_14_c1_syn_hu/x86_64/nax8st_as_nax_q10_gnax.mod\n");
