...
#define nrn_init _nrn_init__Kv1S
#define _nrn_initial _nrn_initial__Kv1S
#define nrn_cur _nrn_cur__Kv1S
#define _nrn_current _nrn_current__Kv1S
#define nrn_jacob _nrn_jacob__Kv1S
#define nrn_state _nrn_state__Kv1S
#define _net_receive _net_receive__Kv1S 
#define rates rates__Kv1S 
#define states states__Kv1S 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Kv1S /Users/maartenkole/Desktop/Human/20_08_14_#1_hu/x86_64/Kv1_soma.mod\n");
